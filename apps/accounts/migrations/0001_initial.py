    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrateur'), ('MANAGER', 'Manager'), ('TECHNICIAN', 'Technicien'), ('READER', 'Lecteur'), ('FORECASTER', 'Prévisionniste'), ('CLIMATOLOGIST', 'Climatologue')], default='READER', max_length=20, verbose_name='Rôle')),
                ...
                ('region', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.region', verbose_name='Région')),
